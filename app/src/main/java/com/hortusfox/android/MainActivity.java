    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.webView.setWebViewClient(new WebViewClient() {
            ...
            public void onPageFinished(WebView view, String url) {
                ...
                view.loadUrl("javascript:(function(){ let ident = document.querySelector('.identify-plant, .plant-identify, .identify-button, .btn-identify, .fa-microscope'); if (ident) { let btn = ident.closest('a, button, div') || ident; btn.style.position = 'fixed'; btn.style.right = '15px'; btn.style.bottom = '145px'; btn.style.zIndex = '9999'; btn.style.width = '55px'; btn.style.height = '55px'; btn.style.borderRadius = '50%'; btn.style.backgroundColor = '#e67e22'; btn.style.display = 'flex'; btn.style.alignItems = 'center'; btn.style.justifyContent = 'center'; btn.style.boxShadow = '0 2px 5px rgba(0,0,0,0.3)'; let ic = btn.querySelector('i'); if (ic) { ic.style.color = '#ffffff'; ic.style.margin = '0'; } } })();");
