    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.webView.setWebViewClient(new WebViewClient() {
            ...
            public void onPageFinished(WebView view, String url) {
                ...
                view.loadUrl("javascript:(function(){ let ident = document.querySelector('.identify-plant, .plant-identify, .identify-button, .btn-identify, .fa-microscope'); if (ident) { let btn = ident.closest('a, button, div') || ident; btn.style.position = 'fixed'; btn.style.right = '20px'; btn.style.bottom = '130px'; btn.style.zIndex = '9999'; } })();");
